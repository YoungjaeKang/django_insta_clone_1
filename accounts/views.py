...
from django.contrib.auth.views import (
    LoginView, logout_then_login, LogoutView, PasswordChangeView as AuthPasswordChangeView,
)
...
# logout = LogoutView.as_view(template_name="")
...
def user_follow(request, username):
    ...
    # request.user 가 follow_user를 팔로우하려고 한다. 그럼 양쪽의 입장이 아래와 같이.
...
def user_unfollow(request, username):
    ...
    # request.user 가 follow_user를 언팔하려고 한다. 그럼 양쪽의 입장이 아래와 같이.
